                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="menuPrincipal">
                        <ul class="navbar-nav mx-auto mb-2 mb-lg-0 fw-medium">
                            ...
                            <li class="nav-item">
                                <a class="nav-link px-3 ${currentPath === 'filtros-avancados.html' ? 'active text-primary fw-bold' : ''}" href="busca-avancada.html">Busca Avançada</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link px-3 ${currentPath === 'minha-biblioteca.html' ? 'active text-primary fw-bold' : ''}" href="biblioteca.html">Minha Biblioteca</a>
                            </li>
                        </ul>
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="minha-biblioteca.html" class="btn btn-primary rounded-pill px-4 fw-semibold">Entrar</a>
                        </div>
                    </div>
                </div>
            </nav>
